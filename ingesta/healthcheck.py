...
OTRA VEZ manana 7:45 desde EAFIT: es otra IP y puede comportarse distinto.
  ...
  python -m ingesta.healthcheck            # bano (default, SKUs confirmados)
  python -m ingesta.healthcheck cocina     # requiere SKUS_POR_AMBIENTE poblado
"""
...
# hecho el primer fetch_all --ambiente de cada uno (tomar 3 de datos/productos.json
