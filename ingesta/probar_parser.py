...
selector esta mal.
  ...
  python -m ingesta.probar_parser pruebas/fixtures/muestra_cat90040.html cat90040 sanitarios
...
from ingesta.parse import leer_html, parse_categoria, parse_guias
...
if __name__ == "__main__":
    a = sys.argv[1:]
    sys.exit(main(a[0] if a else "pruebas/fixtures/muestra_cat90040.html", *a[1:]))
