"""Pipeline determinista: reglas -> catalogo -> negociador -> verificador.
Corre sin LLM y sin red. Es la red de seguridad de demo que usa
agentes.supervisor.correr_deterministico, y la base de pruebas/prove.py.
...
Vive en dominio/ y no en pruebas/ porque no es codigo de test: es el pipeline
determinista real que corre en la demo cuando el modo agentico esta fragil."""
from __future__ import annotations
from config.categorias import CONCEPTO_A_CATEGORIA as MAPA
from dominio import catalogo, negociador, reglas, verificador
from dominio.schemas import Espacio
